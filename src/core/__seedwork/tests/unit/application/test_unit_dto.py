...
from core.__seedwork.application.dto import (Filter, Item, PaginationOutput, PaginationOutputMapper, SearchInput)
...
class TestPaginationOutputMapper(unittest.TestCase):
    ...
    def test_to_output(self):
        ...
        output = PaginationOutputMapper.from_child(PaginationOutputChild).to_output(result.items, result=result)
